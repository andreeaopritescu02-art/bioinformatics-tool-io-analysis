...
Analyze the SAMtools repository and identify all input file formats accepted by the tool.
...
Analyze the SAMtools repository and identify the files and formats generated by the tool.
...
Using the verified findings from Prompts 1-4, produce a machine-readable JSON representation of the SAMtools input/output analysis.
